#!/bin/bash
# ============================================================================
#  myTech.Today - Hosts File Manager Setup
...
echo ""
echo "============================================================"
echo "  myTech.Today - Hosts File Manager Setup"
echo "============================================================"
echo ""
...
echo ""
echo "[INFO] Running Hosts File Manager..."
pwsh -NoProfile -ExecutionPolicy Bypass -File "$SCRIPT_DIR/hosts.ps1" "$@"
echo "[INFO] Complete."
